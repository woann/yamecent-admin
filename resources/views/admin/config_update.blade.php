                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" id="form">
                                <div class="form-group">
                                    <label >* 配置描述</label>
                                    <input type="text"  class="form-control required" name="name" placeholder="配置描述" value="{{ $res->name }}">
                                </div>
                                <div class="form-group">
                                    <label >* 关键字(key)</label>
                                    <input type="text"  class="form-control required" name="config_key" placeholder="key" value="{{ $res->config_key }}">
                                </div>
                                @if($res->type == "string")
                                    <div class="form-group" id="string">
                                        <label >* 配置值(value)</label>
                                        <input type="text" name="config_value" class="form-control value-input" name="config_key" placeholder="key" value="{{ $res->config_value }}">
                                    </div>
                                ...
                                @else
                                    <div class="form-group " id="text">
                                        <label >* 配置值(value)</label>
                                        <textarea  placeholder="请在此处编辑内容" name="config_value" id="editor" style="height:400px;max-height:400px;overflow: hidden">{{ $res->config_value }}</textarea >
                                    </div>
                                @endif
